				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >							
							<option value="HO-PFA-PFC-PEN-WEL">Monthly PF,Pension & Welfare Report</option>
							<option value="HO-HB_MOT_COM_GI">Monthly HB, Motorcycle , Computer & Grp. Ins Deduction Report</option>				
							<option value="HO-GAS_WAT_ELE">Monthly Gas Bill, Water Bill & Electric Bill Report</option>							
							<option value="HO-OTA">Monthly Others Allowance Report</option>
							<option value="HO-OTD">Monthly Others Deduction Report</option>														
						</select>
					</div>
				</div>
				</fieldset>

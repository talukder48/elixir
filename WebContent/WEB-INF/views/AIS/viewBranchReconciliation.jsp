...
function loadgitem(){
	...
	SetValue("Method", "FetchGLReconciliationData","L");	
	xmlFinal();
	$.ajax({
		  method: "POST",
...
{	    
	...
	SetValueReport("Method","InterBranchReconcialition");
				...
				<div class="row">
					...
					<div class="col-75">
						<select id="ReportType" name="ReportType" >
							<option value="InterBranchReconciliation">Reconciliation[Summary]</option>															
						</select>
					</div>
				</div>
				</fieldset>

...
function RejectBatchNumber(event){
	var user = "<%= session.getAttribute("User_Id")%>";
	  ...
	  if (c == true) {
		  ...
		  if(document.getElementById("TransactionDate").value==""){
			  ...
			  if(document.getElementById("BatchNumber").value==""){
				  alert("Transaction Batch Number is Mendatory");
...
function CheckBatchNumber(event){
	var user = "<%= session.getAttribute("User_Id")%>";
	 var c = confirm("Are you sure ?");
	  if (c == true) {		  
		  if(document.getElementById("TransactionDate").value==""){
			  ...
			  if(document.getElementById("BatchNumber").value==""){
				  ...
				  document.getElementById("BatchNumber").focus();
				    ...
				    SetValue("BatchNumber",document.getElementById("BatchNumber").value,"N");		    
					SetValue("Class","elixir.validator.pps.GeneralAccontingSystem","N");
					SetValue("Method","checkTransaction","L");
					xmlFinal();
					$.ajax({
						  method: "POST",
						  url: "CommomAjaxCallHandler",
		  ...
		  if(document.getElementById("TransactionDate").value==""){
			  ...
			  if(document.getElementById("BatchNumber").value==""){
				  ...
				  document.getElementById("BatchNumber").focus();
				    ...
				    SetValue("BatchNumber",document.getElementById("BatchNumber").value,"N");		    
					SetValue("Class","elixir.validator.pps.GeneralAccontingSystem","N");
					SetValue("Method","AuthorizeTransaction","L");
					xmlFinal();
					$.ajax({
						  method: "POST",
						  url: "CommomAjaxCallHandler",
...
{	    
	...
	SetValueReport("BatchNumber",document.getElementById("BatchNumber").value);
	SetValueReport("Class","elixir.report.ics.GeneralAccountingReport");
	SetValueReport("Method","SingleVoucherPrint");
		...
		<fieldset>	
		   <legend>Transaction Details</legend> 			
				...
				<div class="row">
					...
					<div class="col-customize">
						<input type="submit" id="rejId" value="Reject Batch" onclick="RejectBatchNumber()" > <br>
					</div>
										
					<div class="col-customize">
						<input type="submit" id="checkId" value="Check Batch" onclick="CheckBatchNumber()" > <br>
					</div>
										
					<div class="col-customize">
						<input type="submit" id="authId" value="Authorize Batch" onclick="AuthBatchNumber()" > <br>
					</div>
				</div>													
		</div>
		<br><br><br>

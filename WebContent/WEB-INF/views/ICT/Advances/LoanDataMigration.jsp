...
<script type="text/javascript">
	...
	function RealizationDateValidation(event){
		if (event.keyCode == 13 || event.which == 13) {
			if (document.getElementById("RealDate").value != "") {
				document.getElementById("realProcess").focus();
			}
		}
	}
				
	function RealizationProcess(event) {
		var userId= "<%= session.getAttribute("User_Id")%>";
		clear();
		SetValue("EntdBy",userId);		
		SetValue("Year",document.getElementById("Year").value);
		SetValue("RealDate",document.getElementById("RealDate").value);
		...
		SetValue("Method","RealizationProcess");
	...
	<h2>Realization Process</h2>
		<div class="container">					
				...
				<div class="row">
					...
					<div class="col-25">
						<label for="RealDate">Realization Date </label>
					</div>				
					<div class="col-75">
						<input type="text" id="RealDate" value="" onkeypress="RealizationDateValidation(event)" >
					</div>
				</div>								
				<div class="col-75"></div>
				<div class="row">
					<input type="submit" id="realProcess" value="Execute!"
						onclick="RealizationProcess(event)">
				</div>
		</div>	
	</center>
</body>

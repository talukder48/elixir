...
<center>
<h2>Module Wise User Creation</h2>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-15">
						<select id ="UserRole"  onkeypress="UserRoleKeyPress(event)" style="width: 227px;">			        		
			        		<option  value="S">Super Admin User</option>	
			        		<option  value="G">AIS[Admin] User</option>	
			        		<option  value="F">PRMS User</option>	
			        		<option  value="A">HRMS User</option>	
			        		<option  value="P">PNPS User</option>
			        		<option  value="E">ELMS User</option>	
			        		<option  value="Q">MIS USer</option>	
			        		<option  value="M">PRMS[Report View Module]</option>
			        		<option  value="X">Strong Room [Branch]</option>
			        		<option  value="W">Strong Room [Management]</option>
			        		<option  value="Z">Strong Room [Admin]</option>
			   ...
			   <div class="row">
				...
				<div class="row">
					<div class="col-15">
						<label for="ConUserPass">Conirm Password</label>
					</div>
					<div class="col-15">
